...
public class TvFocusGridView extends GridView {
    ...
    public TvFocusGridView(Context contxt) {
        super(contxt);
    ...
    public TvFocusGridView(Context contxt, AttributeSet attrs) {
        super(contxt, attrs);
        setChildrenDrawingOrderEnabled(true);
        setClipChildren(false);
        setClipToPadding(false);
    ...
    public TvFocusGridView(Context contxt, AttributeSet attrs, int defStyle) {
